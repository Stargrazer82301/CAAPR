...
if __name__ == "__main__":
    ...
    if testing:
        CAAPR(temp_dir_path='/home/saruman/spx7cjc/DustPedia/CAAPR_Temp', n_proc=7, sources_table_path='CAAPR_Source_Table_Test.csv', polysub=True, starsub=starsub, fit_apertures=True, do_photom=False, aperture_table_path=aperture_table_path, parallel=parallel)
